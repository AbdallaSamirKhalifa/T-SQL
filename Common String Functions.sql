...
-- Objective: Format the Name and Department columns as a single string, where names are in uppercase, 
-- and department names are in lowercase, separated by a colon (:)
